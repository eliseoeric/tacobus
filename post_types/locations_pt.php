...
function register_locations() {
    ...
    register_post_type( 'location', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
        ...
        array ( 'labels'              => array (
            'name'               => __( 'Locations', 'Tacos' ), /* This is the Title of the Group */
            'singular_name'      => __( 'Location', 'Tacos' ), /* This is the individual type */
            'all_items'          => __( 'All Locations', 'Tacos' ), /* the all items menu item */
            'add_new'            => __( 'Add New', 'Tacos' ), /* The add new menu item */
            'add_new_item'       => __( 'Add New Location', 'Tacos' ), /* Add New Display Title */
            'edit'               => __( 'Edit', 'Tacos' ), /* Edit Dialog */
            'edit_item'          => __( 'Edit Location', 'Tacos' ), /* Edit Display Title */
            'new_item'           => __( 'New Location', 'Tacos' ), /* New Display Title */
            'view_item'          => __( 'View Location', 'Tacos' ), /* View Display Title */
            'search_items'       => __( 'Search Locations', 'Tacos' ), /* Search Custom Type Title */
            ...
            'parent_item_colon'  => ''
                ...
                'description'         => __( 'Post type that holds locations.', 'Tacos' ), /* Custom Type Description */
                'public'              => true,
